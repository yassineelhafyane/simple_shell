...
/**
 *  * err - function tht converts  string to  integer
...
/**
 *  * printf - function tht  prints  decimal number (base 10)
 *   * @inp: input value
 *    * @fd: filedescriptor to write or modify
 *     *
 *      * Return: no of char printed
 *       */
int printf(int inp, int fd)
{
...
/**
 *  * convNUM - function that converts  a no
 *   * @nm: the number
 *    * @base:  the base
 ...
 *       * Return: the string
 *        */
char *convNUM(long int nm, int base, int flag)
{
		static char *arr;
...
/**
 *  * rmCMNTS - function that replaces the first instance of '#' with null
 *   * @buff: address of the string that will be modified
 *    *
 *     * Return: Always 0;
 *      */
void rmCMNTS(char *buff)
{
		int j;
