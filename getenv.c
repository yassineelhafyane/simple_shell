...
/**
 * get_environ - returns string array copy of our environs
 ...
 * @info: Strct containing potential arguments. Used to maintainS
 *        constants function prototype.
 *  Return: 1 on delete, 0 otherwises
 * @var: string env var propertys
 */
